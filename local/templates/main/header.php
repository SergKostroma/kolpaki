...
<div class="side-basket-cosen">
    ...
    <div class="col-12 zakaz js-cart-order" style="display: none">
        <div class="basket-text-cosen">
            ...
            <div class="modal-order-button open-form-button"> К оформлению</div>

        </div>
    </div>

    <!-- <div class="col-12 basket-form hidden ">
...
<div class="modal-block form-modal hidden">
    <div class="order-modal  ">

        <div class="order-modal__title inter">Оформить заказ</div>
        <div class="order-modal__payment">
           <div class="order-modal__payment-method active inter js-payment-method-selection">Наличными </div> 
            <div class="order-modal__payment-method inter js-payment-method-selection">Картой курьеру</div>
        </div>
        ...
        <div class="order-modal__form">
            <form class="js-order-create basket-form">
                ...
                <div class="street-choice">
                    ...
                    <div class="street-choice__list none js-list-addresses ">
                        <div class="street-choice__content ">
                            <div class="street-choice__item inter">Войкова</div>
                            <div class="street-choice__item inter">Индустриальная</div>
                            <div class="street-choice__item inter">Калиновская</div>
        ...
        <button class="modal-order-button inter js-order-submit-buttin js-to-success-modal-btn  "> Оформить заказ на 1220 ₽ </button>
        <div class="order-modal__info inter">Нажимая кнопку Оформить заказ, вы соглашаетесь с <span
                class="privacy-policy">политикой конфиденциальности</span> </div>

        <div class="order-modal__close-btn js-close-form-btn"> <svg class="product-info-modal-close__icon" width="36" height="36" viewBox="0 0 36 36" fill="none"
...
<div class="modal-block js-success-modal hidden">
    <div class="order-modal ">
        <div class="modal-accepted js-order-sucsess">
            ...
            <div class="modal-order-button modal-accepted__btn inter basket-more-button-href js-more-button"><a>Заказать ещё</a></div>
        </div>
        <div class="order-modal__close-btn js-close-success-modal js-more-create-order">
